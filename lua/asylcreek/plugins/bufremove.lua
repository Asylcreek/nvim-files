return {
  ...
  config = function()
    ...
    vim.keymap.set("n", "<leader>C", function() close(0, true) end, { desc = "Force close buffer" })
    vim.keymap.set("n", "<leader>bc", function() close_all(true) end, { desc = "Close all buffers except current" })
    vim.keymap.set("n", "<leader>bC", function() close_all() end, { desc = "Close all buffers" })
