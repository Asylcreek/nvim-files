return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader>gb', function() builtin.git_branches { use_file_path = true } end,
      { desc = "Git branches" })
    vim.keymap.set('n', '<leader>gc', function() builtin.git_commits { use_file_path = true } end,
      { desc = "Git commits for current repository" })
    vim.keymap.set('n', '<leader>gC', function() builtin.git_bcommits { use_file_path = true } end,
